            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex items-start gap-2 rounded-xl bg-emerald-50 p-3">
                    ...
                    <p className="text-xs text-emerald-700 font-medium">
                        Yêu cầu hoàn tiền sẽ được quản trị viên kiểm tra và duyệt. Sau khi duyệt, {refundAmount.toLocaleString()}đ sẽ về ví của bạn và {penaltyFee.toLocaleString()}đ được giữ lại dự án.
                    </p>
                </div>
