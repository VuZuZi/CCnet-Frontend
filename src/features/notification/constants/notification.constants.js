...
export const REALTIME_NOTIFICATION_TYPES = Object.freeze({
  ...
  DISBURSEMENT_STATUS_CHANGED: "disbursement_status_changed",
  DISBURSEMENT_HELD: "disbursement_held",
  DISBURSEMENT_REJECTED: "disbursement_rejected",
  DISBURSEMENT_COMPLETED: "disbursement_completed",
  DISBURSEMENT_TRANSFER_COMPLETED: "disbursement_transfer_completed",
  PROJECT_COMPLETED: "project_completed",
  PROJECT_COMPLETION_SYNCED: "project_completion_synced",
});
...
export const MILESTONE_REALTIME_TYPES = Object.freeze([
  REALTIME_NOTIFICATION_TYPES.EVIDENCE_SUBMITTED_MANUAL,
  REALTIME_NOTIFICATION_TYPES.EVIDENCE_AUTO_APPROVED_GPS,
  REALTIME_NOTIFICATION_TYPES.EVIDENCE_REVIEWED,
  REALTIME_NOTIFICATION_TYPES.MILESTONE_COMPLETED,
  REALTIME_NOTIFICATION_TYPES.PROJECT_COMPLETED,
  REALTIME_NOTIFICATION_TYPES.PROJECT_COMPLETION_SYNCED,
]);

export const DISBURSEMENT_REALTIME_TYPES = Object.freeze([
  REALTIME_NOTIFICATION_TYPES.DISBURSEMENT_REQUESTED,
  REALTIME_NOTIFICATION_TYPES.DISBURSEMENT_APPROVED,
  REALTIME_NOTIFICATION_TYPES.DISBURSEMENT_STATUS_CHANGED,
  REALTIME_NOTIFICATION_TYPES.DISBURSEMENT_HELD,
  REALTIME_NOTIFICATION_TYPES.DISBURSEMENT_REJECTED,
  REALTIME_NOTIFICATION_TYPES.DISBURSEMENT_COMPLETED,
  REALTIME_NOTIFICATION_TYPES.DISBURSEMENT_TRANSFER_COMPLETED,
]);
