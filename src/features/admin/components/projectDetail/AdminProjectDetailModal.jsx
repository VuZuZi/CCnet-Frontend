...
function DocumentPreviewModal({ open, document, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[1200] flex items-center justify-center p-3 sm:p-4">
      ...
      <div
        className="relative z-10 flex h-[88vh] w-full max-w-5xl flex-col overflow-hidden rounded-[30px] border border-amber-100 bg-[linear-gradient(180deg,#FFFDF8_0%,#FFFFFF_100%)] shadow-[0_30px_100px_rgba(15,23,42,0.30)]"
        onClick={(event) => event.stopPropagation()}
      >
        <div className="flex items-center justify-between gap-4 border-b border-amber-100 px-4 py-4 md:px-5">
          <div className="min-w-0 flex items-center gap-3">
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-amber-100 text-[#FBBF24]">
          ...
          <div className="flex items-center gap-2">
            {url ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 rounded-2xl border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-bold text-amber-800 transition hover:bg-amber-100"
              >
        ...
        <div className="min-h-0 flex-1 overflow-auto bg-[linear-gradient(180deg,#FFFDF8_0%,#F8FAFC_100%)]">
          {!url ? (
            <div className="flex h-full flex-col items-center justify-center px-6 text-center">
              <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-3xl border border-amber-100 bg-white text-[#FBBF24] shadow-sm">
                <FileText size={28} />
              </div>
            ...
            <div className="flex h-full flex-col items-center justify-center px-6 text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-flex items-center gap-2 rounded-2xl bg-[#FBBF24] px-4 py-2.5 text-sm font-black text-white transition hover:brightness-105"
              >
                <ExternalLink size={14} />
                Mở tài liệu
              </a>
  ...
  return (
    <>
      <div className="fixed inset-0 z-[999] flex items-center justify-center p-2 sm:p-4">
        ...
        <div
          className="relative z-10 flex h-[94vh] w-full max-w-[1400px] flex-col overflow-hidden rounded-[32px] border border-amber-100 bg-[linear-gradient(180deg,#FFFDF8_0%,#FFFFFF_100%)] shadow-[0_30px_120px_rgba(15,23,42,0.24)]"
          onClick={(event) => event.stopPropagation()}
        >
          <div className="shrink-0 border-b border-amber-100 bg-[linear-gradient(180deg,#FFFFFF_0%,#FFF9EC_100%)]">
            <ProjectDetailHeader
          ...
          <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden bg-[linear-gradient(180deg,#FFFDF7_0%,#FFF8EA_35%,#F8FAFC_100%)] px-3 py-3 md:px-5 md:py-5">
            {shouldShowSkeleton ? (
              <div className="space-y-5">
                <div className="animate-pulse rounded-[28px] border border-amber-100 bg-white p-4 shadow-sm md:p-5">
                  <div className="h-5 w-44 rounded bg-amber-100" />
                  <div className="mt-4 h-56 rounded-[24px] bg-amber-50 md:h-72" />
              ...
              <div className="rounded-[28px] border border-amber-100 bg-white p-8 text-center shadow-sm md:p-10">
                <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-amber-100 text-[#FBBF24]">
              ...
              <div className="space-y-5">
                {isLoadingDetail ? (
                  <div className="inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-4 py-2 text-xs font-black text-amber-800 shadow-sm">
