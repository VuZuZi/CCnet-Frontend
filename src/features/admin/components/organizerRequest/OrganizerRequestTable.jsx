        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Xem xét các đơn đăng ký nâng cấp thành tổ chức đã gửi.
            </p>
          </div>
        ...
        <table className="w-full table-fixed text-sm">
          <thead className="bg-slate-50/90">
            <tr className="text-left text-slate-500">
              ...
              <th className="w-[24%] px-6 py-4 font-bold">Tổ chức</th>
              <th className="w-[16%] px-6 py-4 font-bold">Trạng thái</th>
              <th className="w-[15%] px-6 py-4 font-bold">Ngày nộp</th>
              <th className="w-[15%] px-6 py-4 text-right font-bold">Thao tác</th>
            </tr>
          </thead>
              ...
              <tr>
                <td colSpan="5" className="px-6 py-24 text-center">
                  <p className="text-base font-bold text-slate-700">
                    Không tìm thấy yêu cầu tổ chức nào
                  </p>
