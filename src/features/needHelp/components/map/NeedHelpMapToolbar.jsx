  ...
  return (
    <div className="relative z-[2500] pointer-events-auto overflow-visible rounded-[28px] border border-amber-100/80 bg-white/88 px-4 py-3 shadow-[0_12px_34px_rgba(15,23,42,0.07)] backdrop-blur-xl">
      <div className="flex flex-col gap-3 overflow-visible">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              type="button"
              onClick={onLocateMe}
              className="inline-flex h-11 items-center gap-2 rounded-full border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-50"
            >
            ...
            <Link
              to="/need-help"
              className="inline-flex h-11 items-center gap-2 rounded-full bg-[#FBBF24] px-5 text-sm font-bold text-slate-900 transition-colors hover:bg-amber-500"
            >
              <List size={15} />
              Danh sách
            </Link>
        ...
        <div className="grid overflow-visible gap-2 xl:grid-cols-[minmax(0,1.8fr)_220px_220px_auto]">
          <div className="relative">
            ...
            <input
              ...
              className="h-11 w-full rounded-2xl border border-amber-100 bg-white/90 py-2 pl-9 pr-4 text-sm font-semibold text-slate-700 shadow-sm outline-none transition-all placeholder:text-slate-400 focus:border-amber-400 focus:ring-2 focus:ring-amber-400/20"
            />
          </div>
          ...
          <div className="flex items-center justify-end">
            {hasActiveFilters ? (
              <button
                ...
                className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-50 xl:w-auto"
              >
                <FilterX size={15} />
                Đặt lại
              </button>
