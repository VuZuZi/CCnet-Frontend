...
export function CreateGroupModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[2500] flex items-center justify-center bg-black/35 p-4"
      onClick={onClose}
    >
      <div
        className="flex h-[85vh] w-full max-w-2xl flex-col overflow-hidden rounded-3xl bg-white shadow-2xl"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <input
            ...
            className="mb-5 w-full rounded-2xl border border-slate-200 px-4 py-3 outline-none transition focus:border-amber-400 focus:ring-2 focus:ring-amber-200"
          />
